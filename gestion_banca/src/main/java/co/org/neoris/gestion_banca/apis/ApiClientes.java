 ...
 * Api Cliente
 * Este api contiene el Crud de clientes Crear,Actualizar, Listar y Eliminar
 */
public class ApiClientes extends BasicApi implements IApi {

    private static ApiClientes instance = null;
    private Gson gson = null;
    private String path = "/clientes";
    private ClientePJpaController controller;
    ...
    public static ApiClientes singleton() {
        if (instance == null) {
            instance = new ApiClientes();
        }
        return instance;
    }
    ...
    public Object create(Request rq, Response rs) {
        ...
        if (!body.trim().equals("")) {
            try {
                Clientes entity = gson.fromJson(body, Autor.class);
    ...
    public Object getAll(Request rq, Response rs) {
        Hashtable<String, Object> r = new Hashtable<>();
        List<Clientes> clientes = controller.findAutorEntities();
